@extends('layout')
@section('title') ErasRave - FAQ'S @endsection
            ...
            <div role="tab" id="headingOne1">
              <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="true"
                ...
                <p class="mb-0 dark-grey-text" style="float:left;">
                    <i class="far fa-question-circle"></i> Where are the products made ?
          ...
          <div class="card p-3 my-5">
            ...
            <div role="tab" id="headingOne1">
              <a data-toggle="collapse" data-parent="#accordionEx" href="#heading2"
                ...
                <p class="mb-0 dark-grey-text" style="float:left;">
                    <i class="far fa-question-circle"></i> Are your ingredients and components safe & durable ?
...
selective ingredients.
          ...
          <div class="card p-3 my-5">
            ...
            <div id="heading3" class="collapse" role="tabpanel" aria-labelledby="heading3"
              data-parent="#accordionEx">
              <div class="card-body">
                As it's a startup, we don't have it. In future, it will be generated.
              </div>
            </div>
...
maintain certain formulae to maintain unique quality.
              </div>
            </div>
          ...
          <!-- Q4 -->
            ...
            <div role="tab" id="headingOne5">
              <a data-toggle="collapse" data-parent="#accordionEx" href="#heading5"
                ...
                <p class="mb-0 dark-grey-text" style="float:left;">
                    <i class="far fa-question-circle"></i>If I have a question, what's the fastest way to get an answer ?
            ...
            <div role="tab" id="headingOne7">
              <a data-toggle="collapse" data-parent="#accordionEx" href="#heading7"
                ...
                <p class="mb-0 dark-grey-text" style="float:left;">
                    <i class="far fa-question-circle"></i> Will I be able to track my order ?
                </p>
                <p align="right">
                    <i class="fas fa-angle-down rotate-icon"></i>
             </p>
            ...
            <div id="heading8" class="collapse" role="tabpanel" aria-labelledby="heading8"
              data-parent="#accordionEx">
              <div class="card-body">
             No, but if it is beyond our boundary you may have to.
              </div>
            </div>
            ...
            <div id="heading9" class="collapse" role="tabpanel" aria-labelledby="heading9"
              data-parent="#accordionEx">
              <div class="card-body">
             Yes, we can customise based on your requirements.
              </div>
            </div>
            ...
            <div id="heading10" class="collapse" role="tabpanel" aria-labelledby="heading10"
              data-parent="#accordionEx">
              <div class="card-body">
              You write to us at any time, we will try to satisfy you by
exchanging or any other means.
              </div>
            </div>
            ...
            <div id="heading11" class="collapse" role="tabpanel" aria-labelledby="heading11"
              data-parent="#accordionEx">
              <div class="card-body">
             you can return the product within 10days, if not satisfied.
              </div>
            </div>
