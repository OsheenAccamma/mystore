...
<div align="center" class="container-fluid  my-3   animated bounceIn">
        ...
        <h5 class="my-2" style="color: rgba(245,245,245,0.55)" > Create your Account</h5>
                ...
                <div class="col-md-7" style="width: 100%">
                            ...
                            <form class="form"   method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row mb-0  justify-content-center ">
                                    <div class="col-md-12 ">
                                        <button style="color: rgba(245,245,245,0.52);background-color: rgba(26,26,0,0.79);border-style: none" type="submit" class="btaobtn btaobtn-outline-dark px-2 py-2">
                                            Create My Account
                                        </button><br><br>By Signing up! You are agreeing all the <a style="color: rgba(245,245,245,0.44)" href="{{url('Terms-and-Conditions')}}" target="_blank">Terms and Conditions</a>
                                    </div>
                                    <div class="col-md-6 p-2" style="color: rgba(245,245,245,0.51)">  <strong>Already Have an Account! Please <a href="login" ><u style="color: rgba(245,245,245,0.44)">Login</u></a></strong>
                                    </div>
                                    <div class="col-md-12 ">
                                        or
                                   <p class="my-2">
                                          <a class="black" style="color: rgba(245,245,245,0.5)" href="/">
                                               <i class="fas fa-arrow-left"></i>
                                           <u class="last">Back to ErasRave</u>
                                           </a>
                                   </p>
                                 </div>
                                </div>
