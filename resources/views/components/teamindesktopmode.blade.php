...
{{--          <div class="col-md-3" >--}}
{{--                <div class="card mb-2">--}}
{{--                    <img class="card-img-top  animated pulse infinite slow" src="https://www.btao.in/resources/images/ourteam/Uthappa.png"--}}
{{--                      alt="Card image cap">--}}
{{--                    <div align="left" class="card-body">--}}
{{--                      <h6 class="card-title font-weight-bold" style="font-family: 'Josefin Sans', sans-serif;">Varunl</h6>--}}
