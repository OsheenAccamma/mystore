...
@section('content')
<div align="center" style="background:rgba(51,55,56,0.27);padding:20px;">
  <h3  class="white-text" style="font-weight:bold;"><a href="{{url('admin-dash')}}">Admin Dashboard</a></h3>
